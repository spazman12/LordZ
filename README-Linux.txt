...
-------
  ...
  3. cd ~/LordZ
  4. bash start-lordz.sh

  If you see: env: 'bash\r': No such file or directory
  you are in the wrong folder OR have Windows line endings. Run:
      cd LordZ
      sed -i 's/\r$//' *.sh
      bash start-lordz.sh

  Do NOT run lordz.sh from your home folder unless you extracted the zip there.
